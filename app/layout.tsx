...
export const metadata: Metadata = {
  title: 'Javari Outdoors',
  description: 'AI adventure planning — trail recommendations, gear lists, safety plans, route optimization.',
  keywords: ['Javari AI', 'CR AudioViz AI', 'Javari Outdoors', 'artificial intelligence'],
      ...
      <body style={{ margin: 0, padding: 0, fontFamily: 'system-ui, sans-serif' }}>
        ...
        <div style={{ background: 'rgba(0,0,0,0.85)', backdropFilter: 'blur(8px)', padding: '6px 20px', display: 'flex', alignItems: 'center', justifyContent: 'space-between', position: 'relative', zIndex: 200 }}>
          <a href="https://craudiovizai.com" style={{ display: 'flex', alignItems: 'center', gap: 8, textDecoration: 'none', color: '#fff', fontSize: 13, fontWeight: 600, opacity: 0.85 }}>
            <span>🌲</span>
            <span style={{ color: '#22c55e' }}>Javari Outdoors</span>
            <span style={{ color: '#6b7280', fontSize: 11, marginLeft: 4 }}>by CR AudioViz AI · EIN 39-3646201</span>
          </a>
          <a href="https://craudiovizai.com/auth/signup" style={{ background: '#22c55e', color: '#000', borderRadius: 6, padding: '4px 14px', fontSize: 12, fontWeight: 700, textDecoration: 'none', whiteSpace: 'nowrap' }}>
            Free to Start →
          </a>
        </div>
        {children}
        ...
        <footer style={{ background: '#080808', borderTop: '1px solid rgba(255,255,255,0.06)', padding: '20px 24px', textAlign: 'center' }}>
          ...
          <p style={{ color: '#1f2937', fontSize: 11, margin: 0, fontFamily: 'system-ui' }}>
            ...
            {' '}·{' '}
            <a href="https://craudiovizai.com/auth/signup" style={{ color: '#22c55e', textDecoration: 'none', fontWeight: 600 }}>Sign Up Free</a>
          </p>
        </footer>
      </body>
    </html>
